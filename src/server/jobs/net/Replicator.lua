...
function Replicator:Init()
	...
	main_event.Name = "EVENT" .. EVENT_UUID
	main_event.Parent = rep_svc

	main_function = Instance.new("RemoteFunction")
	main_function.Name = "FUNCTION" .. EVENT_UUID
	main_function.Parent = rep_svc
	...
	main_function.OnServerInvoke = function(client: Player, key: string, ...)
		local listener = listeners[key]
